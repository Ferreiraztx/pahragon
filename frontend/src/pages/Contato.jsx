      ...
      <main className="relative max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <section className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-[#d8e7e3] bg-gradient-to-br from-[#0f766e] to-[#134e4a] p-6 text-white shadow-[0_16px_50px_rgba(15,118,110,0.20)]">
              ...
              {/* Contêiner flexível adicionado para manter os botões lado a lado */}
          ...
          <div className="space-y-4 lg:sticky lg:top-28">
            <div className="overflow-hidden rounded-[28px] border border-white/70 bg-white/80 shadow-[0_10px_40px_rgba(15,23,42,0.06)] backdrop-blur-sm">
