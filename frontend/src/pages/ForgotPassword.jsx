    ...
    <div className="min-h-screen bg-[#faf9f6] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm mt-1">Digite seu e-mail para receber as instruções.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
          ...
          {sucesso && <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm px-4 py-3 rounded-xl mb-6 font-medium">{sucesso}</div>}
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            Lembrou a senha? <Link to="/login" className="text-teal-600 font-bold hover:underline">Voltar para o login</Link>
          </p>
        </div>
      </div>
    </div>
