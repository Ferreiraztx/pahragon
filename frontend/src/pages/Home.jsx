        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-slate-500 text-base sm:text-lg max-w-xl leading-relaxed font-normal">
              A pahragon arena combina o minimalismo de um espaço planejado com
              a energia do beach tennis. Agende sua quadra em segundos e viva
              essa experiência no Santa Quitéria.
            </p>
